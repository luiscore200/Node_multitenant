...
const moverMensajesASesionPendiente = (sessionId) => {
    ...
    exports.crearSession=async (sessionId)=> {
        ...
        const sock = makeWASocket({
            ...
            return new Promise((resolve, reject) => {
                ...
                if(update.qr!==undefined){
                 //   const code = await sock.requestPairingCode("573177229993");
                 ...
                 resolve(update.qr);
                    ...
                    if (update.lastDisconnect?.error?.output?.statusCode !== DisconnectReason.loggedOut) {
                        ...
                        setTimeout(() => exports.crearSession(sessionId), 5000);
                    }
                    if (update.lastDisconnect?.error?.output?.statusCode === DisconnectReason.loggedOut) {
                        console.log("borrando y reintentando");

                        exports.clearSession(sessionId);
                        exports.crearSession(sessionId);
                    }
                }
